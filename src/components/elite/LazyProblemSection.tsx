...
const LazyProblemSection = ({ onCTAClick }: LazyProblemSectionProps) => {
  return (
    <>
      {/* SEÇÃO: DIAGNÓSTICO */}
      <section className="py-8 md:py-12 px-4">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-black mb-6 md:mb-8 text-gradient leading-tight">
