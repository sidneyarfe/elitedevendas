  ...
  return <div className="min-h-screen bg-background text-foreground">
      ...
      <WorkshopSection background="card" className="relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          <div className="mb-8">
            <Badge className="bg-gradient-workshop text-black font-bold text-lg px-6 py-3 animate-pulse mb-4">
              BÔNUS EXCLUSIVO
            </Badge>
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Quem garantir uma das 10 primeiras vagas ganha de presente:
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="bg-card border-2 border-workshop-gold/30 rounded-2xl p-8 shadow-glow">
                <div className="flex items-center justify-center gap-3 mb-6">
                  <div className="bg-gradient-workshop rounded-full w-12 h-12 flex items-center justify-center">
                    <span className="text-black font-black text-xl">+20</span>
                  </div>
                ...
                <div className="space-y-4 text-left">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-workshop-gold flex-shrink-0 mt-1" />
                    <p className="text-lg">Mais de 20 materiais sobre vendas</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-workshop-gold flex-shrink-0 mt-1" />
                    <p className="text-lg">Marketing estratégico avançado</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-workshop-gold flex-shrink-0 mt-1" />
                    <p className="text-lg">Gestão comercial profissional</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-workshop-gold flex-shrink-0 mt-1" />
                    <p className="text-lg">Templates e roteiros exclusivos</p>
                  </div>
                </div>

                <div className="mt-8 p-6 bg-gradient-workshop-subtle rounded-xl border border-workshop-gold/20">
                  <p className="text-sm font-bold text-workshop-gold mb-2">VALOR TOTAL DO BÔNUS:</p>
                  <p className="text-3xl font-black text-gradient">R$ 497</p>
                  <p className="text-sm text-muted-foreground mt-1">GRÁTIS para os 10 primeiros</p>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 md:order-2">
              <div className="relative">
                <img 
                  src="/lovable-uploads/173e3022-26d1-40d4-9512-64406dd402de.png" 
                  alt="Bônus: +20 Materiais Exclusivos sobre Vendas, Marketing e Gestão Comercial" 
                  className="w-full h-auto rounded-2xl shadow-2xl border border-workshop-gold/20"
                />
                <div className="absolute -top-4 -right-4">
                  <div className="bg-gradient-workshop text-black font-bold px-4 py-2 rounded-full shadow-lg animate-bounce">
                    GRÁTIS!
                  </div>
                </div>
              </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-xl font-bold text-workshop-gold mb-6">
              ⚡ Restam apenas <span className="text-gradient">10 vagas</span> para este bônus especial!
            </p>
            <div className="flex justify-center">
              <WorkshopButton className="text-lg md:text-xl py-4 md:py-6 px-8 md:px-12 animate-pulse-glow">
