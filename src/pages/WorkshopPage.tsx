      ...
      <div>
        ...
        <WorkshopSection padding="default" className="bg-black text-white">
          <div className="text-center">
            <h1 className="text-3xl md:text-6xl font-black mb-6 leading-tight text-white">
            ...
            <div className="text-lg md:text-2xl mb-8 text-gray-200 max-w-5xl mx-auto font-medium leading-relaxed">
