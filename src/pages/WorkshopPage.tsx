...
import onOfficeInterior from "@/assets/on-office-interior.jpg";
...
// Image mapping function with correct imports
const loadImage = (imageName: string) => {
  switch(imageName) {
    case 'rodrigo-ana-mobile': return rodrigoAnaMobile;
    case 'rodrigo-ana-desktop': return rodrigoAnaDesktop;
    case 'dr-rafael': return drRafael;
    case 'on-office-interior': return onOfficeInterior;
    case 'foto_ana': return fotoAna;
    case 'foto_rodrigo': return fotoRodrigo;
    case 'onoffice_sala': return onOfficeSala;
    case 'onoffice_local': return onOfficeLocal;
    case 'workshop-elite-logo': return workshopEliteLogo;
    default: return '';
  }
};
...
const WorkshopPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="absolute inset-0 flex items-end md:items-end justify-center md:hidden">
            <div className="w-full text-center text-white px-4 pb-8 md:pb-32">
              ...
              <div className="text-base md:text-xl lg:text-2xl mb-6 md:mb-8 text-gray-200 max-w-5xl mx-auto font-medium leading-relaxed">
                ...
                <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-4 md:mb-6">
                  <div className="bg-workshop-gold/20 backdrop-blur-sm border border-workshop-gold/30 px-3 md:px-6 py-2 md:py-3 rounded-xl shadow-glow/30 hover:bg-workshop-gold/30 transition-all duration-300">
                    <div className="flex items-center gap-2 md:gap-3">
                      <svg className="w-4 h-4 md:w-6 md:h-6 text-workshop-gold" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="bg-workshop-gold/20 backdrop-blur-sm border border-workshop-gold/30 px-3 md:px-6 py-2 md:py-3 rounded-xl shadow-glow/30 hover:bg-workshop-gold/30 transition-all duration-300">
                    <div className="flex items-center gap-2 md:gap-3">
                      <svg className="w-4 h-4 md:w-6 md:h-6 text-workshop-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-lg md:text-2xl lg:text-3xl font-bold">você vai <span className="text-gradient">DOBRAR suas vendas em 7 dias</span> — sem gastar mais R$1.</p>
              </div>
        ...
        <div className="hidden md:block">
          <WorkshopSection padding="default" className="bg-black text-white -mt-20">
            <div className="text-center">
              ...
              <div className="text-xl lg:text-2xl mb-8 text-gray-200 max-w-5xl mx-auto font-medium leading-relaxed">
                ...
                <p className="text-2xl lg:text-3xl font-bold">você vai <span className="text-gradient">DOBRAR suas vendas em 7 dias</span> — sem gastar mais R$1.</p>
              </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 p-4 rounded-xl">
              ...
              <p className="text-sm font-medium text-red-700 dark:text-red-300">Influencer</p>
            </div>
            <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 p-4 rounded-xl">
              <div className="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-white text-xl">✕</span>
              </div>
              <p className="text-sm font-medium text-red-700 dark:text-red-300">Conteúdo</p>
            </div>
          </div>
          
          <div className="bg-green-50 dark:bg-green-950/20 border-2 border-green-500 p-8 rounded-2xl mb-8">
            <div className="flex items-center justify-center gap-4 mb-4">
              <div className="w-12 h-12 bg-green-500 rounded-full flex items-center justify-center">
                <CheckCircle className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-green-700 dark:text-green-300">
                E dependendo APENAS de uma simples mensagem no WhatsApp.
              </h3>
            </div>
          </div>
          
          <div className="flex justify-center">
            <WorkshopButton onClick={() => scrollToSection('metodo')} className="text-lg md:text-xl py-4 md:py-6 px-8 md:px-12">
      ...
      {/* SEÇÃO: MÉTODO */}
      <WorkshopSection id="metodo" background="gradient" className="relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-black mb-16 text-gradient">
              No Workshop Elite de Vendas você aprende:
            </h2>
              ...
              <div className="bg-background border border-workshop-gold/20 p-4 md:p-8 rounded-2xl hover:shadow-glow transition-all duration-300">
                <div className="flex items-start gap-3 md:gap-6">
                  ...
                  <div className="text-left">
                    <h3 className="text-base md:text-2xl font-bold mb-2 md:mb-4">Como extrair uma lista qualificada de +5.000 potenciais clientes em menos de 30 segundos.</h3>
                  </div>
                </div>
              </div>
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-8 mb-12">
            ...
            <div className="bg-background border border-workshop-gold/20 p-4 md:p-8 rounded-2xl hover:shadow-glow transition-all duration-300">
              ...
              <p className="text-sm md:text-lg">8h às 18h (ambos os dias)</p>
            </div>
            ...
            <div className="bg-background border border-workshop-gold/20 p-4 md:p-8 rounded-2xl hover:shadow-glow transition-all duration-300">
              ...
              <p className="text-sm md:text-lg">OnOffice - Nazaré, Belém</p>
            </div>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-6 text-workshop-gold">Sala do Evento</h3>
              <OptimizedImage 
                src={loadImage('onoffice_sala')} 
                alt="Sala do Workshop - OnOffice Belém" 
                className="w-full rounded-2xl mb-4 border border-workshop-gold/20"
              />
            </div>
            
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-6 text-workshop-gold">Localização</h3>
              <OptimizedImage 
                src={loadImage('onoffice_local')} 
                alt="Localização OnOffice - Nazaré, Belém" 
                className="w-full rounded-2xl mb-4 border border-workshop-gold/20"
              />
            </div>
          </div>
