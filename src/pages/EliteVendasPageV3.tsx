...
const EliteVendasPageV3 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Workshop Elite de Vendas V3 - Dobre Suas Vendas em 2 Dias AO VIVO | Belém-PA</title>
        <meta 
          name="description" 
        ...
        <meta property="og:title" content="Workshop Elite de Vendas V3 - Dobre Suas Vendas em 2 Dias AO VIVO" />
        ...
        <meta property="og:url" content="https://lp.alavanc.com/elitedevendas-v3" />
        <link rel="canonical" href="https://lp.alavanc.com/elitedevendas-v3" />
...
export default EliteVendasPageV3;